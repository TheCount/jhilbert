 ...
 */
public class Parameter extends AbstractName {
	 ...
	 */
	public Parameter(final String name, final String locator, final List<Parameter> parameterList,
			final String prefix) {
		super(name);
	 ...
	 */
	Parameter(final String name, final DataInputStream in, final Data data, final List<String> nameList,
	...
	void store(final DataOutputStream out, final Map<String, Integer> parameterNameTable) throws IOException {
		...
		for (Parameter parameter: parameterList)
			out.writeInt(parameterNameTable.get(parameter.getName()));
